                ...
                foreach ( $__blocks[$__pos] as $__values )
                {
                    ...
                    if ( ! empty( $content ) or defined( 'NV_IS_DRAG_BLOCK' ) )
                    {
						...
						if ( defined( 'NV_IS_DRAG_BLOCK' ) )
                        {
                            ...
                            <div class="bl_header">
                            <a href="javascript:void(0)" class="block_content" name="' . $__values['bid'] . '" title="' . $lang_global['edit_block'] . '">
                                ' . $lang_global['edit_block'] . '</a> | <a href="javascript:void(0)" class="delblock" name="' . $__values['bid'] . '" title="' . $lang_global['delete_block'] . '">
                                ' . $lang_global['delete_block'] . '</a> | <a href="javascript:void(0)" class="outgroupblock" name="' . $__values['bid'] . '" title="' . $lang_global['delete_block'] . '">
                                ' . $lang_global['outgroup_block'] . '</a>
                            </div>
                            ' . $b_content . '</div>';
                        }

		...
		<table width="100%" style="margin-bottom:0">
			<tr>
				...
				<table summary="" class="tab1" style="margin-bottom:0">
					<tbody>
						<tr>
							<td colspan="2"><strong>{LANG.content_zsize}</strong></td>
						</tr>
					</tbody>
					<tbody class="second" id="zsize">
						<tr>
							<td width="110px"><strong>{LANG.size}</strong></td>
							<td><strong>{LANG.order_product_price}</strong></td>
						</tr>
						<!-- BEGIN: zsize -->					
							<tr id='size_{id}' class='size_row'>
								...
								<input type="button" value="Bỏ" id="remove_{id}" onclick="nv_remove_size(this)"/>
								</td>
							</tr>
						<!-- END: zsize -->
					</tbody>
					<tfoot>
						<tr>
							<td colspan="4">
								<input type="button" value="{LANG.content_zaddsize}" onclick="nv_add_size();">
							</td>
						</tr>
					</tfoot>
				</table>

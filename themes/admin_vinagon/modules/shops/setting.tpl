...
<table summary="" class="tab1">
    ...
    <tbody class="second">
		<tr>
			<td><strong>{LANG.setting_active_commentfb}</strong></td>
			<td><input type="checkbox" value="1" name="active_comfb" {ck_active_comfb} id="active_comfb" /></td>
		</tr>
	</tbody>
<table class="tab1" summary="">
	<tbody>
		<tr>
            <td><strong>{LANG.setting_detail_tel}</strong></td>
            <td><input type="text" value="{DATA.detail_tel}" style="width: 200px;" name="detail_tel" /></td>
            <td><strong>{LANG.setting_detail_email}</strong></td>
            <td><input type="text" value="{DATA.detail_email}" style="width: 200px;" name="detail_email" /></td>
		</tr>
	</tbody>
</table>
<table class="tab1" summary="">
    <tbody class="second">
		<tr>
			<td width="20%"><strong>{LANG.setting_detail_note}</strong></td>
			<td><textarea name="detail_note" rows="3" cols="4" style="width: 99%;">{DATA.detail_note}</textarea></td>
		</tr>
	</tbody>
    <tbody class="second">
		<tr>
			<td><strong>{LANG.setting_detail_note2}</strong></td>
			<td>{edit_detail_note2}</td>
		</tr>
	</tbody>
    </table>
<table>

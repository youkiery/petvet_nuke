...
<div id="edit">
    ...
    <table summary="" class="tab1">
      ...
      <tbody>
        <tr>
        <td align="right"><strong>{LANG.catalog_image}: </strong></td>
        <td><input style="width: 650px" name="image" id="image" type="text" value="{DATA.image}" maxlength="255" />
			<input type="button" name="selectimg" value="Browse server">
		</td>
        </tr>
      </tbody>
      <tbody>
        <tr>
        <td align="right"><strong>{LANG.catalog_image}: </strong></td>
        <td><input style="width: 650px" name="icon" id="icon" type="text" value="{DATA.icon}" maxlength="255" />
			<input type="button" name="selecticon" value="Browse server"><img src="{DATA.icon}">
		</td>
        </tr>
      </tbody>
      <tbody>

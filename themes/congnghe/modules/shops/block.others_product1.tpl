...
<!-- BEGIN: main -->
<div class="pro_slide">
                <h3 class="pro_title"><i class="icons icons_arrow"></i>{TITLE} <a class="read_more" href="{LINK_FULL}" style="float:right">Xem thêm >></a></h3>
                <div class="pro_slide_list product_list">
                    ...
                    <!-- BEGIN: loop -->
                          <li>
                            ...
                            <a href="{link}" class="icons mua_hang"></a>3
                          </li>

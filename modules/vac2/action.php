...
// $sql_create_module[] = "CREATE TABLE `" . VAC_PREFIX . "_customers` (
//   `id` int(11) NOT NULL,
...
// $sql_create_module[] = "ALTER TABLE `" . VAC_PREFIX . "_customers`
// 	ADD PRIMARY KEY (`id`);"

// $sql_create_module[] = "ALTER TABLE `" . VAC_PREFIX . "_customers`
// MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;"

// $sql_create_module[] = "CREATE TABLE `" . VAC_PREFIX . "_pets` (
//   `id` int(11) NOT NULL,

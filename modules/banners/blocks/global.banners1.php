...
if ( ! nv_function_exists( 'nv_block_data_config_banners1' ) )
{

    function nv_block_data_config_banners1 ( $module, $data_block, $lang_block )
    {
    ...
    function nv_block_data_config_banners1_submit ( $module, $lang_block )
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
    ...
    function nv_block_global_banners1 ( $block_config )
    {
        ...
        $xtpl = new XTemplate( "global.banners1.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/blocks" );
		//print_r(NV_ROOTDIR . "/themes/" . $block_theme . "/blocks");exit();
...
{
    $content = nv_block_global_banners1( $block_config );
}

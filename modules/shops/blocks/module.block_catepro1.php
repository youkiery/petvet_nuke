...
if ( ! nv_function_exists( 'nv_cate_product1' ) ) {
	function nv_block_config_cate1_blocks ( $module, $data_block, $lang_block ) {
	...
	function nv_block_config_cate1_blocks_submit ( $module, $lang_block ) {
		global $nv_Request;
		$return = array();
		$return['error'] = array();
		$return['config'] = array();
	...
	function nv_cate_product1 ( $block_config ) {
...
if ( defined( 'NV_SYSTEM' ) ) {
	global $site_mods;
	$module = $block_config['module'];
	$content = nv_cate_product1( $block_config );
}
?>

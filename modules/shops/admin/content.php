...
$size_id = 0;
while (list($id, $product_id, $size, $product_price) = $db -> sql_fetchrow($result_size)) {
	$xtpl -> assign('zsize', $size);
	$xtpl -> assign('zprice', $product_price);
	$xtpl -> assign('id', $size_id);
	$xtpl -> parse('main.zsize');
	$size_id ++;
}

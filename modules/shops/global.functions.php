...
function nv_products_page ( $base_url, $num_items, $per_page, $start_item, $add_prevnext_text = true )
{
    ...
    if ( $total_pages > 10 )
    {
        ...
        for ( $i = 1; $i <= $init_page_max; $i ++ )
        {
            ...
            $link = explode("/", $url);
            if(count($link) > 2) {
                $href = "href=\"$link[0]/$link[1]/$link[2]/$link[3]/page-" . ( ( $i - 1 ) * $per_page ) . ".html\"";
            }
            else {
                $link2 = explode("&", $url);
                $href = "href=\"$link2[0]&$link2[1]&$link2[2]&$link2[3]&$link2[4]&page=" . ( ( $i - 1 ) * $per_page ) . "\"";
            }
            ...
            if ( $on_page > 1 && $on_page < $total_pages )
            {
                ...
                for ( $i = $init_page_min - 1; $i < $init_page_max + 2; $i ++ )
                {
                    ...
                    if(count($link) > 2) {
                        ...
                        $link2 = explode("&", $url);
                        $href = "href=\"$link2[0]&$link2[1]&$link2[2]&$link2[3]&$link2[4]&page=" . ( ( $on_page - 2 ) * $per_page ) . "\"";
                    }
                    $page_string .= ( $i == $on_page ) ? "<strong>" . $i . "</strong>" : "<a " . $href . ">" . $i . "</a>";
    ...
    if ( $add_prevnext_text )
    {
        if ( $on_page > 1 )
        {
            ...
            $link = explode("/", $url);
            if(count($link) > 2) {
                $href = "href=\"$link[0]/$link[1]/$link[2]/$link[3]/page-" . ( ( $on_page - 2 ) * $per_page ) . ".html\"";
            }
            else {
                $link2 = explode("&", $url);
                $href = "href=\"$link2[0]&$link2[1]&$link2[2]&$link2[3]&$link2[4]&page=" . ( ( $on_page - 2 ) * $per_page ) . "\"";
        ...
        if ( $on_page < $total_pages )
        {
            ...
            $link = explode("/", $url);
            if(count($link) > 2) {
                $href = "href=\"$link[0]/$link[1]/$link[2]/$link[3]/page-" . ( $on_page * $per_page ) . ".html\"";
            }
            else {
                $link2 = explode("&", $url);
                $href = "href=\"$link2[0]&$link2[1]&$link2[2]&$link2[3]&$link2[4]&page=" . ( $on_page * $per_page ) . "\"";
            }

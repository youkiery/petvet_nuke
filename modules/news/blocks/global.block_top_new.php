...
if ( ! nv_function_exists( 'nv_top_news_blocks' ) )
{
    ...
    function nv_top_news_blocks ( $block_config )
    {
        ...
        if ( ! empty( $list ) )
        {
            if ( file_exists( NV_ROOTDIR . "/themes/" . $module_info['template'] . "/modules/news/block_top_news.tpl" ) )
            {
            ...
            $xtpl = new XTemplate( "block_top_news.tpl", NV_ROOTDIR . "/themes/" . $block_theme . "/modules/news" );
            foreach ( $list as $l )
            {
...
if ( defined( 'NV_SYSTEM' ) )
{
    ...
    if ( isset( $site_mods[$module] ) )
    {
        ...
        $content = nv_top_news_blocks( $block_config );
    }
}

...
function nv_show_list ()
{
    ...
    if ( $num > 0 )
    {
        ...
        while ( $row = $db->sql_fetchrow( $result ) )
        {
			...
			$contents .= "<td  align=\"center\">" . $row['skype_item'] . "</td>\n";
			$contents .= "<td  align=\"center\"><a href=\"skype:" . $row['skype_item'] . "?chat\"><img border=\"0\" alt=\"\" src=\"http://mystatus.skype.com/" . $row['skype_type'] . "/" . $row['skype_item'] . "\"/></a></td>\n";
			$contents .= "<td  align=\"center\">" . $row['yahoo_item'] . "</td>\n";
			$contents .= "<td  align=\"center\"><a href=\"ymsgr:sendim?" . $row['yahoo_item'] . "\"><img border=\"0\" alt=\"\" src=\"http://opi.yahoo.com/online?u=" . $row['yahoo_item'] . "&m=g&t=" . $row['yahoo_type'] . "\"/></a></td>\n";
		...
		$contents .= "<thead>\n";
        $contents .= "<tr>\n";
		$contents .= "<td colspan=\"10\" align=\"center\"><span class=\"add_icon\"><a href=\"" . NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=content\">" . $lang_module['support10'] . "</a></span></td>\n";
		$contents .= "</tr>\n";
        $contents .= "</thead>\n";
...
function nv_show_list_group ()
{
    ...
    if ( $num > 0 )
    {
		...
		$contents .= "<thead>\n";
        $contents .= "<tr>\n";
        $contents .= "<td colspan=\"3\" align=\"center\"><span class=\"add_icon\"><a href=\"" . NV_BASE_ADMINURL . "index.php?" . NV_NAME_VARIABLE . "=" . $module_name . "&" . NV_OP_VARIABLE . "=group_content\">" . $lang_module['support17'] . "</a></span></td>\n";
		$contents .= "</tr>\n";
        $contents .= "</thead>\n";
